...
class StubCsvStore(BaseCsvStore):
    ...
    def setup(self):
        ...
        self.datasets["cpih/2022-3/1"] = Path(content_dir / "cpih/2022-3/1.csv").absolute()
        self.datasets["cpih/2022-3/2"] = Path(content_dir / "cpih/2022-3/2.csv").absolute()
        self.datasets["cpih/2022-3/3"] = Path(content_dir / "cpih/2022-3/3.csv").absolute()
